...
<article class="contenido-receta bg-white p-5 shadow">
    ...
    <div class="imagen-receta">
        <img src="/storage/{{$receta->imagen}}" alt="{{$receta->titulo}}" class="w-100"></div>
    <div class="receta-meta mt-5">
        ...
        <p>
            ...
            <a class="text-dark" href="{{route('perfiles.show', ['perfil' => $receta->autor->perfil->id])}}">
                {{$receta->autor->name}}
            </a>
        </p>
        <p>
        ...
        <div class="justify-content-center row text-center">
            {{-- componene de Vue para los me gusta --}}
